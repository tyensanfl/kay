                ...
                <ComnCodDetalTableStyled>
                    <tbody>
                        <tr>
                            ...
                            <th>그룹 코드 명</th>
                            <td>
                                <input type="text" name="grp_cod_nm" defaultValue={state.grpCodNm} readOnly={true}></input>
                            </td>
                        </tr>
                        <tr>
                            <th>상세 코드 id </th>
                            <td>
                                ...
                                onChange={(e) => setComnDetail({...comnDetail, dtl_cod: e.target.value})} readOnly={detailCod ? true : false}></input>
                            </td>
                            <th>상세 코드 명</th>
                            <td>
                                <input type="text" defaultValue={comnDetail?.dtl_cod_nm}
                                onChange={(e) => setComnDetail({...comnDetail, dtl_cod_nm: e.target.value})}></input>
                            </td>
                        </tr>
                        <tr>
                            <th>코드 설명</th>
                            <td colSpan={3}>
                                ...
                                onChange={(e) => setComnDetail({...comnDetail, dtl_cod_eplti: e.target.value})}></input>
                            </td>
                        </tr>
                        <tr>
                            <th>사용 유무 *</th>
                            <td colSpan={3}>
                                ...
                                onChange={(e) => setComnDetail({...comnDetail, use_poa: e.target.value})}></input>
                                사용
